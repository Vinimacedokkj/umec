document.addEventListener('DOMContentLoaded', function() {
            ...
            telefoneInput.addEventListener('input', function(e) {
                ...
                if (value.length <= 11) {
                    if (value.length === 11) {
                        ...
                        // Aplicar máscara parcial enquanto digita
                        if (value.length <= 2) {
                            value = `(${value}`;
    ...
    function gerarQRCode() {
        ...
        if (qrCodeDiv && !qrCodeDiv.hasChildNodes()) {
            ...
            const qrCodeHTML = `<div style="width: 200px; height: 200px; display: flex; align-items: center; justify-content: center; border-radius: 10px; margin: 0 auto;">
